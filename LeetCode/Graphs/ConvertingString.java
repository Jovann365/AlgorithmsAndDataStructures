...
/*
https://leetcode.com/problems/minimum-cost-to-convert-string-i/description/?envType=problem-list-v2&envId=graph
...
public class ConvertingString {
    ...
    public static void main(String[] args) {
        ...
        String source1 = "abcd", target1 = "abce";
        char [] original1 = {'a'}, changed1 = {'e'};
        int [] cost1 = {10000};
        //System.out.println(minimumCost(source1, target1, original1, changed1, cost1));

        String source2 ="aabbddccbc", target2 ="abbbaabaca";
        char [] original2 ={'a','b','c','b','a','d'}, changed2 = {'d','c','b','d','b','b'};
        int [] cost2 ={3,8,7,6,7,10};
